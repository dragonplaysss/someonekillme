...
try:
    ...
    # Test the failure method (which should now be used instead of error)
    print("\nTesting response_engine.failure method:")
    embed = response_engine.failure("Access Denied", "Only the sole owner can use this command.")
